...
class Obstacle {
    ...
    checkCollision() {
        ...
        var obst = {x: this.dimensions[0], y: this.dimensions[1], width: this.currentPosition[0], height: this.currentPosition[1]};
        var playPos = {x: gamePlayer.dimensions[0], y: gamePlayer.dimensions[1], width: gamePlayer.currentPosition[1], height: gamePlayer.currentPosition[1]};

        if (obst.x < gamePlayer.x + gamePlayer.width && obst.x + obst.width > gamePlayer.x && obst.y < gamePlayer.y + gamePlayer.height && obst.y + obst.height > gamePlayer.y) {
            game.gameOver();
        }
        
        console.log(this.currentPosition);
        console.log(game.players[0].currentPosition);
