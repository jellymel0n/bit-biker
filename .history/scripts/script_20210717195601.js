...
class Obstacle {
    ...
    checkCollision() {
        ...
        let obst = {x: this.dimensions[0], y: this.dimensions[1], width: this.currentPosition[0], height: this.currentPosition[1]};

        let playPos = {x: gamePlayer.dimensions[0], y: gamePlayer.dimensions[1], width: gamePlayer.currentPosition[0], height: gamePlayer.currentPosition[1]};
        ...
        if (playPos.x < obst.x + obst.width && playPos.x + playPos.width > obst.x && playPos.y < obst.y + obst.height && playPos.y + playPos.height > obst.y) {
            console.log('game-over');
            // game.gameOver();
        }
