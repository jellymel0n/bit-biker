...
const game = {
    ...
    animationFrameLoop: (ts) => {
        ...
        const levelTime = game.song.currentTime;
        if (levelTime = 1){
            game.gameLevel = 0;
        } else if (levelTime = 48) {
            game.gameLevel = 1;
        } else if (levelTime = 91) {
            game.gameLevel = 2;
        } else if (levelTime = 129) {
            game.gameLevel = 3;
        } else if (levelTime = 164) {
            game.gameLevel = 4;
        } else if (levelTime = 168) {
            game.gameLevel = 5;
        } else if (levelTime = 175) {
            game.gameLevel = 6;
        } else if (levelTime = 180) {
            game.gameLevel = 7;
        };
