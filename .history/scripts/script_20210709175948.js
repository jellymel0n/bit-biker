...
const game = {
    ...
    gameOver: () => {
        ...
        if (game.distance > game.highScore) {
            ...
            $('#highscoreCheck').text(`New Highscore! <br> ${game.playerName}: ${game.highScore} m`);
        } else {
            $("#gOverDistance").text(`Distance: ${game.distance} m`);
        }
    ...
    gameComplete: () => {
        ...
        if (game.distance >= game.highScore) {
            game.highScore = game.distance;
            $('#completeHSCheck').text(`New Highscore! <br> ${game.playerName}: ${game.highScore} m`);
        } else {
